...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Renko");
const u8 gText_ExpandedPlaceholder_May[] = _("Maribel");
...
const u8 gText_Pokemon[POKEMON_NAME_LENGTH + 1] = _("Party");
...
const u8 gText_Boy[] = _("Tomboy");
const u8 gText_Girl[] = _("Girlish");
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “Puppet.”{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? Puppet");
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching Puppets were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for Puppets based on\nselected parameters.");
const u8 gText_SwitchPokedexListings[] = _("Switch TohoDex listings.");
const u8 gText_ReturnToPokedex[] = _("Return to the TohoDex.");
const u8 gText_SelectPokedexMode[] = _("Select the TohoDex mode.");
const u8 gText_SelectPokedexListingMode[] = _("Select the TohoDex listing mode.");
...
const u8 gText_DexHoennDescription[] = _("Hoenn region's TohoDex");
const u8 gText_DexNatDescription[] = _("National edition TohoDex");
const u8 gText_DexSortNumericalDescription[] = _("Puppets are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned Puppets are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned Puppets are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned Puppets are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned Puppets are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned Puppets are listed from the\nsmallest to the tallest.");
...
const u8 gText_HOFDexRating[] = _("Spotted Puppets: {STR_VAR_1}!\nOwned Puppets: {STR_VAR_2}!\pProf. Birch's TohoDex rating!\pProf. Birch: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("Prof. Birch is in trouble!\nRelease a Puppet and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this Puppet?");
...
const u8 gText_ThePokemonList[] = _("the Puppet List");
...
const u8 gText_PkmnHoldingItemCantHoldMail[] = _("This Puppet is holding an\nitem. It cannot hold MAIL.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailTransferredFromMailbox[] = _("Mail was transferred from\nthe MAILBOX.{PAUSE_UNTIL_PRESS}");
const u8 gText_BagFullCouldNotRemoveItem[] = _("The Bag is full. The Puppet's\nitem could not be removed.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ChoosePokemon[] = _("Choose a Puppet.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which Puppet?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which Puppet?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which Puppet?");
...
const u8 gText_NoPokemonForBattle[] = _("No Puppet for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a Puppet.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} Puppets are needed.");
const u8 gText_PokemonCantBeSame[] = _("Puppets can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose Puppet or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose Puppet and confirm.");
const u8 gText_SendWhichMonToPC[] = _("Send which Puppet to the PC?");
...
const u8 gText_PkmnCantParticipate[] = _("That Puppet can't participate.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That Puppet can't be traded\nnow.");
ALIGNED(4) const u8 gText_PkmnCantBeTraded[] = _("That Puppet can't be traded.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An Egg can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other Trainer's Puppet\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of Puppet\nthat the other Trainer wants.");
...
const u8 gText_RentalPkmn[] = _("RENTAL Puppets");
...
const u8 gText_PkmnInfo[] = _("Puppet INFO");
const u8 gText_PkmnSkills[] = _("Puppet SKILLS");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd Puppet Egg found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar Puppet Egg\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar Puppet Egg\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A Puppet Egg obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd Puppet Egg\nobtained from a traveler.");
...
const u8 gText_MenuOptionPokedex[] = _("TohoDex");
const u8 gText_MenuOptionPokemon[] = _("Party");
const u8 gText_MenuOptionBag[] = _("Bag");
const u8 gText_MenuOptionPokenav[] = _("iDollNav");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the Puppet Mail?");
...
const u8 gText_PokemonLeague[] = _("Hoenn League");
const u8 gText_PokemonCenter[] = _("Puppet Center");
...
const u8 gText_TrainerCardPokedex[] = _("TohoDex");
...
const u8 gText_BattlePalaceDesc[] = _("Watch your Puppets battle!\nYour spirit will be tested.");
const u8 gText_BattleArenaDesc[] = _("Win battles with teamed-up Puppets!\nYour guts will be tested.");
const u8 gText_BattleFactoryDesc[] = _("Aim for victory using rental Puppets!\nYour knowledge will be tested.");
...
const u8 gText_MenuPokedex[] = _("TohoDex");
...
const u8 gText_RentalPkmn2[] = _("Rental Puppets");
const u8 gText_SelectFirstPkmn[] = _("Select the first Puppet.");
const u8 gText_SelectSecondPkmn[] = _("Select the second Puppet.");
const u8 gText_SelectThirdPkmn[] = _("Select the third Puppet.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three Puppets OK?");
const u8 gText_Yes2[] = _("YES");
const u8 gText_No2[] = _("NO");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same {PKMN}.");
const u8 gText_PkmnSwap[] = _("Puppet Swap");
const u8 gText_SelectPkmnToSwap[] = _("Select Puppet to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select Puppet to accept.");
...
const u8 gText_AcceptThisPkmn[] = _("Accept this Puppet?");
...
const u8 gText_SavingPokedex[] = _("TohoDex");
...
const u8 gText_PokeBalls[] = _("MIKO ORBS");
