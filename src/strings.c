...
const u8 gText_Pokemon[POKEMON_NAME_LENGTH + 1] = _("Bonéka");
...
const u8 gText_PokedexRegistration[] = _("iDollDex registration completed.");
...
const u8 gText_SwitchPokedexListings[] = _("Switch iDollDex listings.");
const u8 gText_ReturnToPokedex[] = _("Return to the iDollDex.");
const u8 gText_SelectPokedexMode[] = _("Select the iDollDex mode.");
const u8 gText_SelectPokedexListingMode[] = _("Select the iDollDex listing mode.");
...
const u8 gText_DexHoennDescription[] = _("Hoenn region's iDollDex");
const u8 gText_DexNatDescription[] = _("National edition iDollDex");
...
const u8 gText_HOFDexRating[] = _("Spotted Bonéka: {STR_VAR_1}!\nOwned Bonéka: {STR_VAR_2}!\pProf. Birch's iDollDex rating!\pProf. Birch: Let's see…\p");
...
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other Trainer's Bonéka\ncan't be traded now.");
...
const u8 gText_MenuOptionPokedex[] = _("iDollDex");
...
const u8 gText_TrainerCardPokedex[] = _("iDollDex");
...
const u8 gText_MenuPokedex[] = _("iDollDex");
const u8 gText_MenuPokemon[] = _("Bonéka");
const u8 gText_MenuBag[] = _("Bag");
const u8 gText_MenuPokenav[] = _("iDollNav");
...
const u8 gText_SavingPokedex[] = _("iDollDex");
