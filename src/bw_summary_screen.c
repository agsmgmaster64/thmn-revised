...
const u16 sSummaryScreen_Pal_BW_AWR[]                       = INCGFX_U16("graphics/summary_screen/bw/tiles_awr.png", ".gbapal");
...
static const union AnimCmd sSpriteAnim_TypeFaith[] = {
...
static const union AnimCmd *const sSpriteAnimTable_MoveTypes[NUMBER_OF_MON_TYPES + CONTEST_CATEGORIES_COUNT] = {
    ...
    [TYPE_FAITH] = sSpriteAnim_TypeFaith,
...
static const union AnimCmd sSpriteAnim_TeraTypeFaith[] = {
...
static const union AnimCmd *const sSpriteAnimTable_TeraType[NUMBER_OF_MON_TYPES] = {
    ...
    [TYPE_FAITH] = sSpriteAnim_TeraTypeFaith,
...
static void SetMonTypeIcons(void)
{
    ...
    if (summary->isEgg)
    {
        SetTypeSpritePosAndPal(TYPE_NONE, 68, 46, SPRITE_ARR_ID_TYPE);
