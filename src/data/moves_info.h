...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_LEER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Frightens foes with a\n"
            "leer to lower Defense. (-1)"),
        .effect = EFFECT_STAT_CHANGE,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_FOCUS_ENERGY] =
    {
        ...
        .description = COMPOUND_STRING(
            "Focuses power to raise\n"
            "critical-hit ratio. (+1)"),
    ...
    [MOVE_SKULL_BASH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Two-turn attack with high\n"
            "critical hit ratio. Also\n"
            "raises Atk by 1 stage."),
    ...
    [MOVE_CURSE] =
    {
        ...
        .description = COMPOUND_STRING(
            "User loses 50% Max HP to\n"
            "curse the target, draining\n"
            "25% Max HP per turn."),
        .effect = EFFECT_CURSE,
        .power = 0,
        .type = TYPE_GHOST,
    ...
    [MOVE_FURY_CUTTER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Doubles in power on each\n"
            "consecutive hit. (Max 160)"),
        .power = 40,
    ...
    [MOVE_HEAL_BELL] =
    {
        ...
        .description = COMPOUND_STRING(
            "A chime that clears all\n"
            "statuses on your party."),
    ...
    [MOVE_SACRED_FIRE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A mystical fire strike that\n"
            "may inflict a burn. (20%)"),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FAITH,
        .accuracy = 85,
    ...
    [MOVE_ENCORE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Target repeats its move\n"
            "for the next 3 turns, and\n"
            "this turn also if slower."),
    ...
    [MOVE_RAPID_SPIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Spins and removes hazards.\n"
            "Also increases Speed. (+1)"),
    ...
    [MOVE_MEMENTO] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user faints to harshly\n"
            "lower Atk/Sp.Atk. (-2/-2)"),
    ...
    [MOVE_FOCUS_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Strikes at -3 priority.\n"
            "The user stops if hit."),
    ...
    [MOVE_FOCUS_STANCE] =
    {
        .name = COMPOUND_STRING("Focus Stance"),
        .description = COMPOUND_STRING(
            "The user slows down to focus\n"
            "and improve Physical stats.\n"
            "(+1 Atk/Def) (-1 Spd)"),
        .effect = EFFECT_STAT_CHANGE,
        .power = 0,
        .type = TYPE_NORMAL,
