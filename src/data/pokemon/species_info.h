...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    #include "species_info/touhou_1_families.h"
    #include "species_info/touhou_2_families.h"
    #include "species_info/touhou_3_families.h"
    #include "species_info/touhou_4_families.h"
    #include "species_info/touhou_5_families.h"
    #include "species_info/touhou_6_families.h"
    #include "species_info/touhou_7_families.h"
    #include "species_info/touhou_8_families.h"
    #include "species_info/touhou_9_families.h"
    ...
    #include "species_info/touhou_13_families.h"
    #include "species_info/touhou_14_families.h"
    #include "species_info/touhou_15_families.h"
    #include "species_info/touhou_16_families.h"
    #include "species_info/touhou_17_families.h"
    #include "species_info/touhou_18_families.h"
    #include "species_info/touhou_19_families.h"
    #include "species_info/touhou_20_families.h"
    #include "species_info/touhou_spinoff_families.h"
    #include "species_info/touhou_print_families.h"
    #include "species_info/touhou_fanmade_families.h"
    #include "species_info/misc_families.h"
