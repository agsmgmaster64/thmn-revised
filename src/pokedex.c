...
static const u8 sText_PokedexRegistration[] = _("TohoDex registration completed.");
...
static const u8 sText_NoMatchingPkmnWereFound[] = _("No matching Puppets were found.");
static const u8 sText_SearchForPkmnBasedOnParameters[] = _("Search for Puppets based on\nselected parameters.");
static const u8 sText_SwitchPokedexListings[] = _("Switch TohoDex listings.");
static const u8 sText_ReturnToPokedex[] = _("Return to the TohoDex.");
static const u8 sText_SelectPokedexMode[] = _("Select the TohoDex mode.");
static const u8 sText_SelectPokedexListingMode[] = _("Select the TohoDex listing mode.");
static const u8 sText_ListByFirstLetter[] = _("List by the first letter in the name.\nSpotted Puppets only.");
...
static const struct SearchOptionText sDexSearchTypeOptions[] =
{
    ...
    {sText_DexEmptyString, gTypesInfo[TYPE_FAITH].name},
