...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNCUTSATTACKWITH]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} cuts {B_DEF_NAME_WITH_PREFIX2}'s {B_BUFF1}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNPREVENTSSTATGAINWITH]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} prevents stat gain!"), //not in gen 5+, ability popup
    ...
    [STRINGID_ITSUCKEDLIQUIDOOZE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was hurt by the miasma!"),
    ...
    [STRINGID_NEUTRALIZINGGASENTERS]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} is nullifying abilities!"),
    [STRINGID_NEUTRALIZINGGASOVER]                  = COMPOUND_STRING("Abilities are no longer being suppressed!"),
