...
static void CB2_ShowPokemonSummaryScreen(void)
{
    ...
    {
        if (BW_SUMMARY_SCREEN)
            ShowPokemonSummaryScreen_BW(SUMMARY_MODE_NORMAL, gParties[B_TRAINER_0], gPartyMenu.slotId, gPartiesCount[B_TRAINER_0] - 1, CB2_ReturnToPartyMenuFromSummaryScreen);
        else
...
{
    if (BW_SUMMARY_SCREEN)
        ShowSelectMovePokemonSummaryScreen_BW(gParties[B_TRAINER_0], gPartyMenu.slotId, CB2_ReturnToPartyMenuWhileLearningMove, gPartyMenu.data1);
    else
...
{
    if (BW_SUMMARY_SCREEN)
        ShowPokemonSummaryScreen_BW(SUMMARY_MODE_SELECT_MOVE, gParties[B_TRAINER_0], gSpecialVar_0x8004, gPartiesCount[B_TRAINER_0] - 1, CB2_ReturnToField);
    else
