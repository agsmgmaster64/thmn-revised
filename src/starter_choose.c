...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_CHIBI_ELLEN)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_CHIBI_SARA)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_CHIBI_KURUMI )
