...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COLLECTOR] = { _("Otaku"), 15, BALL_PREMIER },
    ...
    [TRAINER_CLASS_POKEMANIAC] = { _("Doll Maniac"), 15 },
    ...
    [TRAINER_CLASS_BUG_MANIAC] = { _("Worker"), 15 },
    ...
    [TRAINER_CLASS_SR_AND_JR] = { _("Sr. & Jr."), 4 },
    [TRAINER_CLASS_WINSTRATE] = { _("Winstrate"), 10 },
    [TRAINER_CLASS_POKEFAN] = { _("Plush Fan"), 20 },
    [TRAINER_CLASS_YOUNGSTER] = { _("Youngster"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("Champion"), 50, BALL_ULTRA },
    [TRAINER_CLASS_FISHERMAN] = { _("Fisher"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("Triathlete"), 10 },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("Villain"), 12 },
	...
	[TRAINER_CLASS_PASSER_BY] = { _("Passer-By"), 10 },
	[TRAINER_CLASS_TRIO_ADM_AOI] = { _("Trio Adm AOI"), 15 },
	[TRAINER_CLASS_GRAND_MASTER] = { _("Grand Master"), 50 },
	[TRAINER_CLASS_NURSE] = { _("Nurse"), 8 },
	[TRAINER_CLASS_X_TRAINER] = { _("X Trainer"), 50 },
	[TRAINER_CLASS_ANIMAC_CREW] = { _("Animac Crew"), 8},
	[TRAINER_CLASS_ANIMAC_ADMIN] = { _("Animac Admin"), 15},
	[TRAINER_CLASS_AOI_ELITE_GX] = { _("AOI Elite GX"), 20},
	[TRAINER_CLASS_AOI_ELITE_SP] = { _("AOI Elite SP"), 20},
        ...
        if (gimmick != GIMMICK_Z_MOVE)
        {
            if (state == MON_IN_BATTLE)
            {
                ...
                if (gimmick == GIMMICK_TERA && ((teraType = GetMonData(mon, MON_DATA_TERA_TYPE)) != TYPE_STELLAR))
                    return teraType;
                if (types[0] != TYPE_NONE && !(gBattleMons[battler].volatiles.roostActive && types[0] == TYPE_FLYING))
                    return types[0];
                if (types[1] != TYPE_NONE && !(gBattleMons[battler].volatiles.roostActive && types[1] == TYPE_FLYING))
                    return types[1];
