...
#define I_SITRUS_BERRY_HEAL             GEN_LATEST  // In Gen4+, Sitrus Berries heal 25% of max HP instead of 30 HP.
...
#define I_PRICE                         GEN_3  // Some items have varied in value across generations. See src/data/items.h for values.
...
// Vs. Seeker
#define I_VS_SEEKER_CHARGING        FLAG_SYS_VS_SEEKER_CHARGING    // If this flag is assigned, the Vs. Seeker functionality will be enabled. When the player has the Vs. Seeker, Match Call rematch functions will stop working. Documentation for the Vs. Seeker can be found in docs/tutorials/vs_seeker.md.
...
#define I_ORAS_DOWSING_FLAG         1       // Replace 0 with an unused flag to enable the Dowsing Machine mechanic from ORAS.
