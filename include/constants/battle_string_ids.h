...
enum StringID
{
    ...
    STRINGID_PKMNPREVENTSSTATGAINWITH,
    ...
    STRINGID_PKMNANGRY,
    STRINGID_PKMNEATING,
    STRINGID_POWERLEAKBOOST,
    STRINGID_WALLMASTERACTIVATES,
    STRINGID_TWINSPARKACTIVATES,
    STRINGID_BLANKCARDACTIVATES,
    STRINGID_DEVOURHEAL,
    STRINGID_LASTWISH,
    STRINGID_LASTWISHCAMETRUE,
    STRINGID_LASTGRUDGE,
    STRINGID_MYREALMSET,
    STRINGID_MYREALMUNSET,
    STRINGID_BUZZERBLOCKED,
    ...
    STRINGID_DEBTSPIRALDEPLETION,
    STRINGID_POVERTYSCATTERED,
    STRINGID_APOLLON_START,
    STRINGID_TARGETCURSED,
    STRINGID_BEGINSREGENERATING,
    STRINGID_PKMNTRAPPEDINDESTITUTION,
    STRINGID_IDENTIFY,
    STRINGID_IDENTIFYITEMABILITY,
    STRINGID_IDENTIFYMOVESET1,
    STRINGID_IDENTIFYMOVESET2,
    STRINGID_SCHEMING,
    STRINGID_ABILITYBECAMELEVITATE,
    STRINGID_EARTHISSHAKING,
    STRINGID_PKMNCURSEDSELF,
    STRINGID_PKMNWRAPPEDINCHAINS,
    STRINGID_COUNT
};
...
enum WrappedStringID
{
    ...
    B_MSG_WRAPPED_DESTITUTION,
    B_MSG_WRAPPED_ONIBINDING,
    NUM_TRAPPING_MOVES,
};
