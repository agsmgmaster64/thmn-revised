...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_PLAY_GHOST = 319,
    ABILITY_INFECTIOUS = 320,
    ABILITY_MELODY = 321,
    ABILITY_POISON_BODY = 322,
    ABILITY_FIRE_VEIL = 323,
    ABILITY_WALL_OF_ICE = 324,
    ABILITY_ONI_STRENGTH = 325,
    ABILITY_LAZY = 326,
    ABILITY_SERVANT = 327,
    ABILITY_MASTER = 328,
    ABILITY_STRONG_GRIP = 329,
    ABILITY_SELF_CARE = 330,
    ABILITY_MARVEL_VEIL = 331,
    ABILITY_STRANGE_MIST = 332,
    ABILITY_FORTIFIED = 333,
    ABILITY_MANA_BARRIER = 334,
    ABILITY_NYUDO = 335,
    ABILITY_GUARD_ARMOR = 336,
    ABILITY_UNCONSCIOUS = 337,
    ABILITY_SOLID_BODY = 338,
    ABILITY_OCCULT_BOOST = 339,
    ABILITY_RELENTLESS = 340,
    ABILITY_MAGIC_ARMOR = 341,
    ABILITY_INDIGNANT = 342,
    ABILITY_INTERDICT = 343,
    ABILITY_WONDER_VEIL = 344,
    ABILITY_FLAME_ABSORB = 345,
    ABILITY_FLORA_ABSORB  = 346,
    ABILITY_CONSECRATE = 347,
    ABILITY_FASCINATE = 348,
    ABILITY_UNWAVERING  = 349,
    ABILITY_AMBITION = 350,
    ABILITY_COLD_HEART = 351,
    ABILITY_INNER_POWER = 352, //not borderless inner power
    //borderless imports
	ABILITY_LUNACY = 353,
	ABILITY_POWER_LEAK = 354,
	ABILITY_HIBERNATION = 355,
	ABILITY_WINTER_GIFT = 356,
	ABILITY_PURE_ENIGMA = 357,
	ABILITY_ABERRANT = 358,
	ABILITY_STORM_SHAWL = 359,
	ABILITY_HARMONIZE = 360,
	ABILITY_LECTURE = 361,
	ABILITY_SOUR_NOTE = 362,
	ABILITY_HIGH_NOTE = 363,
	ABILITY_JEALOUSY = 364,
	ABILITY_PRIDE = 365,
	ABILITY_WALL_MASTER = 366,
	ABILITY_CATALYST = 367,
	ABILITY_TWIN_SPARK = 368,
	ABILITY_GOURMAND = 369,
	ABILITY_BLANK_CARD = 370,
	ABILITY_REACTIVE = 371,
	ABILITY_DEVOUR = 372,
	ABILITY_LOST_DREAM = 373,
	ABILITY_LAST_WISH = 374,
	ABILITY_LAST_GRUDGE = 375,
	ABILITY_SALVAGE = 376,
	ABILITY_TOXICOLOGIST = 377,
	ABILITY_GRAND_THEORY = 378,
	ABILITY_CHARISMATIC = 379,
