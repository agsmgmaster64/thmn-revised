...
enum __attribute__((packed)) Ability
{
    ...
    //revised abils
    ABILITY_HAKUREI_MIKO = 311,
    ABILITY_INNATE_DREAM = 312,
    ABILITY_GAP = 313,
    ABILITY_HISOUTEN = 314,
    ABILITY_MYSTERIOUS = 315,
    ABILITY_FLAWLESS = 316,
    ABILITY_GATE_KEEPER = 317,
    ABILITY_DOLL_WALL = 318,
    ABILITY_DOLL_SKEWER = 319, //concept from borderless but here for ordering
    ABILITY_PLAY_GHOST = 320,
    ABILITY_INFECTIOUS = 321,
    ABILITY_MELODY = 322,
    ABILITY_POISON_BODY = 323,
    ABILITY_FIRE_VEIL = 324,
    ABILITY_WALL_OF_ICE = 325,
    ABILITY_ONI_STRENGTH = 326,
    ABILITY_LAZY = 327,
    ABILITY_SERVANT = 328,
    ABILITY_MASTER = 329,
    ABILITY_STRONG_GRIP = 330,
    ABILITY_SELF_CARE = 331,
    ABILITY_MARVEL_VEIL = 332,
    ABILITY_STRANGE_MIST = 333,
    ABILITY_FORTIFIED = 334,
    ABILITY_MYSTIC_BARRIER = 335,
    ABILITY_NYUDO = 336,
    ABILITY_GUARD_ARMOR = 337,
    ABILITY_UNCONSCIOUS = 338,
    ABILITY_SOLID_BODY = 339,
    ABILITY_OCCULT_BOOST = 340,
    ABILITY_RELENTLESS = 341,
    ABILITY_MAGIC_ARMOR = 342,
    ABILITY_INDIGNANT = 343,
    ABILITY_INTERDICT = 344,
    ABILITY_WONDER_VEIL = 345,
    ABILITY_FLAME_ABSORB = 346,
    ABILITY_FLORA_ABSORB  = 347,
    ABILITY_CONSECRATE = 348,
    ABILITY_FASCINATE = 349,
    ABILITY_UNWAVERING  = 350,
    ABILITY_AMBITION = 351,
    ABILITY_COLD_HEART = 352,
    ABILITY_INNER_POWER = 353, //not borderless inner power
    //borderless imports
	ABILITY_LUNACY = 354,
	ABILITY_POWER_LEAK = 355,
	ABILITY_HIBERNATION = 356,
	ABILITY_WINTER_GIFT = 357,
	ABILITY_PURE_ENIGMA = 358,
	ABILITY_ABERRANT = 359,
	ABILITY_STORM_SHAWL = 360,
	ABILITY_HARMONIZE = 361,
	ABILITY_LECTURE = 362,
	ABILITY_SOUR_NOTE = 363,
	ABILITY_HIGH_NOTE = 364,
	ABILITY_JEALOUSY = 365,
	ABILITY_PRIDE = 366,
	ABILITY_WALL_MASTER = 367,
	ABILITY_CATALYST = 368,
	ABILITY_TWIN_SPARK = 369,
	ABILITY_GOURMAND = 370,
	ABILITY_BLANK_CARD = 371,
	ABILITY_REACTIVE = 372,
	ABILITY_DEVOUR = 373,
	ABILITY_LOST_DREAM = 374,
	ABILITY_LAST_WISH = 375,
	ABILITY_LAST_GRUDGE = 376,
	ABILITY_SALVAGE = 377,
	ABILITY_TOXICOLOGIST = 378,
	ABILITY_GRAND_THEORY = 379,
	ABILITY_YIN_AND_YANG = 380,
	ABILITY_ARSONIST = 381,
	ABILITY_LOGICIAN = 382,
	ABILITY_TIME_CONTROL = 383,
	ABILITY_MY_REALM = 384,
	ABILITY_SWORDMASTER = 385,
	ABILITY_ATHEISM = 386,
	ABILITY_FIRM_DEFENSE = 387,
	ABILITY_SUNBATHING = 388,
	ABILITY_LAST_PRANK = 389,
	ABILITY_BUZZER = 390,
	ABILITY_SAND_CASTLE = 391,
	ABILITY_STASIS_GAZE = 392,
	ABILITY_PURE_SCALES = 393,
	ABILITY_VERSATILE = 394,
	ABILITY_AMBUSH = 395,
    ABILITY_MULTIGRAZE = 396,
    ABILITY_CHARISMATIC = 397,
    ABILITY_FOCUS = 398,
    ABILITY_GAP_BLOCK = 399,
    ABILITY_ANGER_BREAK = 400,
    ABILITY_KAGURA = 401,
    ABILITY_BAKED_POTATO = 402,
    ABILITY_CONTAGION = 403,
    ABILITY_ORB_FETCH = 404,
    ABILITY_SACRED_VEIL = 405,
    ABILITY_SOOTHING_SMOKE = 406,
    ABILITY_BEER_BREW = 407,
    ABILITY_MISERY = 408,
    ABILITIES_COUNT_REVISED,
    ABILITY_PIERCING_DRILL = 409,
    ABILITY_DRAGONIZE = 410,
    ABILITY_EELEVATE = 411,
    ABILITY_314 = 412,
    ABILITY_MEGA_SOL = 413,
    ABILITY_FIRE_MANE = 414,
    ABILITY_317 = 415,
    ABILITY_SPICY_SPRAY = 416,
    ABILITIES_COUNT_CHAMPIONS,
    ABILITIES_COUNT = ABILITIES_COUNT_CHAMPIONS,
};
