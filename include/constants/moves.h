...
enum __attribute__((packed)) Move
{
    ...
    MOVE_DRAWN_LINE = 851,
    MOVE_BLACK_RIPPLE = 852,
    MOVE_JAMMING = 853,
    MOVE_DECISION = 854,
    MOVE_PURIFICATION = 855,
    MOVE_SAKURA_STORM = 856,
    MOVE_MANA_BURST = 857,
    MOVE_RECOLLECTION = 858,
    MOVE_BLADE_FLASH = 859,
    MOVE_LUNATIC = 860,
    MOVE_SOAR = 861,
    ...
    MOVE_KNIFE_THROW = 867,
    MOVE_KNIFE_WAVE = 868,
    MOVE_SCULPTURE = 869,
    MOVE_ONI_BINDING = 870,
    MOVE_MERMAID_SONG = 871,
    MOVE_TENKO_LASER = 872,
    MOVE_COLD_INFERNO = 873,
    MOVE_HISOU_SWORD = 874,
    MOVE_POWER_TRANCE = 875,
    MOVE_MYSTIC_BOMB = 876,
    MOVE_BUG_GRIP = 877,
    MOVE_HOLY_NEEDLE = 878,
    MOVE_GLACIAL_BASH = 879,
    MOVE_EERIE_WAVE = 880,
    MOVE_SHOCK_ABSORB = 881,
    MOVE_SPECTRAL_RAY = 882,
    MOVE_ARTIFICIAL_SUN = 883,
    MOVE_SKITTER_RUSH = 884,
    MOVE_MINDS_EYE = 885,
    MOVE_MANA_PUNCH = 886,
    MOVE_GAP_ZONE = 887,
    MOVE_POWER_DRUM = 888,
    MOVE_DRACULA_CRADLE = 889,
    MOVE_SAKE_DRINK = 890,
    MOVE_BUTTERFLY = 891,
    MOVE_SUPEREGO = 892,
    MOVE_JUDGEMENT = 893,
    MOVE_ZAP_FLARE = 894,
    MOVE_SAVAGE_STING = 895,
    MOVE_DIVINE_PULSE = 896,
    MOVE_MULTI_PULSE = 897,
    MOVE_HOLY_STRIKE = 898,
    MOVE_FIRE_BULLETS = 899,
    MOVE_AQUA_VEIL = 900,
    MOVE_NERVE_PRESS = 901,
    MOVE_FUJIYAMA_VOLCANO = 902,
    MOVE_MANA_CHARGE = 903,
    MOVE_CORPSE_RUSH = 904,
    MOVE_TOXIC_CLAW = 905,
    MOVE_RING_OF_FIRE = 906,
    MOVE_SUWA_DELUGE = 907,
    MOVE_APOLLO_13 = 908,
    MOVE_BUG_WHISTLE = 909,
    MOVE_HOURAI_REND = 910,
    MOVE_WATER_GEYSER = 911,
    MOVE_ROCK_GALE = 912,
    MOVE_POISON_WAVE = 913,
    MOVE_HEART_BREAK = 914,
    MOVE_GALE_DANCE = 915,
    MOVE_TRI_RHAPSODY = 916,
    MOVE_AQUA_TRIP = 917,
    MOVE_ZAP_CHOP = 918,
    MOVE_PSYSLAP = 919,
    MOVE_GOLD_RUSH = 920,
    MOVE_MIND_BOMB = 921,
    MOVE_OMINOUS_HIT = 922,
    MOVE_PHANTOM_SLASH = 923,
    MOVE_ALLOY_SHOT = 924,
    MOVE_TREMOR = 925,
    MOVE_GIGA_FLARE = 926,
    MOVE_MANASHOCK = 927,
    ...
    MOVE_RAPID_FIRE = 932,
    MOVE_MISHAGUJI = 933,
    MOVE_AEGIS_MERGE = 934,
    MOVE_EXTERMINATE = 935,
    MOVE_SUTRA = 936,
    ...
    MOVE_CATACLYSM = 949,
    MOVE_BLOSSOMING = 950,
    MOVE_PASSION_DANCE = 951,
    MOVE_ANOXIC_FUMES = 952,
    MOVE_INVOCATION = 953,
    MOVE_AURA_BREAK = 954,
    MOVE_FALL_KICK = 955,
    MOVE_RECALIBRATE = 956,
