...
#define PLAYER_AVATAR_GFX_MALE_NORMAL          OBJ_EVENT_GFX_RENKO_NORMAL
#define PLAYER_AVATAR_GFX_MALE_MACH_BIKE       OBJ_EVENT_GFX_RENKO_MACH_BIKE
#define PLAYER_AVATAR_GFX_MALE_ACRO_BIKE       OBJ_EVENT_GFX_RENKO_ACRO_BIKE
#define PLAYER_AVATAR_GFX_MALE_SURFING         OBJ_EVENT_GFX_RENKO_SURFING
#define PLAYER_AVATAR_GFX_MALE_UNDERWATER      OBJ_EVENT_GFX_RENKO_UNDERWATER
#define PLAYER_AVATAR_GFX_MALE_FIELD_MOVE      OBJ_EVENT_GFX_RENKO_FIELD_MOVE
#define PLAYER_AVATAR_GFX_MALE_FISHING         OBJ_EVENT_GFX_RENKO_FISHING
#define PLAYER_AVATAR_GFX_MALE_WATERING        OBJ_EVENT_GFX_RENKO_WATERING
#define PLAYER_AVATAR_GFX_MALE_VSSEEKER        OBJ_EVENT_GFX_RENKO_VS_SEEKER
#define PLAYER_AVATAR_GFX_MALE_VSSEEKER_BIKE   OBJ_EVENT_GFX_RENKO_VS_SEEKER_BIKE
#define PLAYER_AVATAR_GFX_FEMALE_NORMAL        OBJ_EVENT_GFX_MARIBEL_NORMAL
#define PLAYER_AVATAR_GFX_FEMALE_MACH_BIKE     OBJ_EVENT_GFX_MARIBEL_MACH_BIKE
#define PLAYER_AVATAR_GFX_FEMALE_ACRO_BIKE     OBJ_EVENT_GFX_MARIBEL_ACRO_BIKE
#define PLAYER_AVATAR_GFX_FEMALE_SURFING       OBJ_EVENT_GFX_MARIBEL_SURFING
#define PLAYER_AVATAR_GFX_FEMALE_UNDERWATER    OBJ_EVENT_GFX_MARIBEL_UNDERWATER
#define PLAYER_AVATAR_GFX_FEMALE_FIELD_MOVE    OBJ_EVENT_GFX_MARIBEL_FIELD_MOVE
#define PLAYER_AVATAR_GFX_FEMALE_FISHING       OBJ_EVENT_GFX_MARIBEL_FISHING
#define PLAYER_AVATAR_GFX_FEMALE_WATERING      OBJ_EVENT_GFX_MARIBEL_WATERING
#define PLAYER_AVATAR_GFX_FEMALE_VSSEEKER      OBJ_EVENT_GFX_MARIBEL_VS_SEEKER
#define PLAYER_AVATAR_GFX_FEMALE_VSSEEKER_BIKE OBJ_EVENT_GFX_MARIBEL_VS_SEEKER_BIKE
...
enum
{
    ...
    OBJ_EVENT_GFX_RENKO_NORMAL,
    OBJ_EVENT_GFX_RENKO_FIELD_MOVE,
    OBJ_EVENT_GFX_RENKO_VS_SEEKER,
    OBJ_EVENT_GFX_RENKO_VS_SEEKER_BIKE,
    OBJ_EVENT_GFX_RENKO_SURFING,
    OBJ_EVENT_GFX_RENKO_MACH_BIKE,
    OBJ_EVENT_GFX_RENKO_ACRO_BIKE,
    OBJ_EVENT_GFX_RENKO_FISHING,
    OBJ_EVENT_GFX_RENKO_WATERING,
    OBJ_EVENT_GFX_RENKO_DECORATING,
    OBJ_EVENT_GFX_RENKO_UNDERWATER,
    OBJ_EVENT_GFX_MARIBEL_NORMAL,
    OBJ_EVENT_GFX_MARIBEL_FIELD_MOVE,
    OBJ_EVENT_GFX_MARIBEL_VS_SEEKER,
    OBJ_EVENT_GFX_MARIBEL_VS_SEEKER_BIKE,
    OBJ_EVENT_GFX_MARIBEL_SURFING,
    OBJ_EVENT_GFX_MARIBEL_MACH_BIKE,
    OBJ_EVENT_GFX_MARIBEL_ACRO_BIKE,
    OBJ_EVENT_GFX_MARIBEL_FISHING,
    OBJ_EVENT_GFX_MARIBEL_WATERING,
    OBJ_EVENT_GFX_MARIBEL_DECORATING,
    OBJ_EVENT_GFX_MARIBEL_UNDERWATER,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_PLAYER_THMN             0x1134
