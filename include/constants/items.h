...
enum __attribute__((packed)) Item
{
    ...
    ITEM_TOPAZ = 895,
    ITEM_DIAMOND = 896,
    ITEM_PEARL_STONE = 897,
    ITEM_AMETHYST = 898,

    ITEM_SCARLET_TOME = 899,
    ITEM_GOLDEN_TOME = 900,
    ITEM_MAGIC_TOME = 901,
    ITEM_AZURE_TOME = 902,
    ITEM_JADE_TOME = 903,
    ITEM_AQUA_TOME = 904,
    ...
    ITEM_REMOTE_CONTROLLER = 906,
    ITEM_X_COUPON = 907,
    ITEM_LINK_SYSTEM = 908,
    ITEM_JX_PASS = 909,
    ITEM_DREAM_STONE = 910,

    ITEM_MIKO_ZIRCON = 911,
    ITEM_MAGE_ZIRCON = 912,
    ITEM_PRISM_ZIRCON = 913,
    ITEM_LEAF_ZIRCON = 914,
