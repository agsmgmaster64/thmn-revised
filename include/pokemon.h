...
struct BoxPokemon
{
    ...
    /*0x2C*/ enum Move move1:11; // 2047 moves.
             u16 attackIV:5;
    /*0x2E*/ enum Move move2:11; // 2047 moves.
             u16 defenseIV:5;
    /*0x30*/ enum Move move3:11; // 2047 moves.
             u16 speedIV:5;
    /*0x32*/ enum Move move4:11; // 2047 moves.
             u16 spAttackIV:5;
    ...
    /*0x44*/ u8 tough;
    /*0x45*/ u8 sheen;
    /*0x46*/ u16 coolRibbon:3;     // Stores the highest contest rank achieved in the Cool category.
             u16 beautyRibbon:3;   // Stores the highest contest rank achieved in the Beauty category.
             u16 cuteRibbon:3;     // Stores the highest contest rank achieved in the Cute category.
             u16 smartRibbon:3;    // Stores the highest contest rank achieved in the Smart category.
             u16 toughRibbon:3;    // Stores the highest contest rank achieved in the Tough category.
             u16 unused:1;    // Stores the highest contest rank achieved in the Tough category.
};
