...
extern const u8 BattleScript_FascinatePrevented[];
extern const u8 BattleScript_FascinateInReverse[];
...
extern const u8 BattleScript_AbilityNoStatGain[];
...
extern const u8 BattleScript_ReactiveActivates[];
